...
/**
 *
 *  Template Name: Thank You High Performance
 *
        ...
        <div class="container">
            <div class="row">
                <header class="entry-header service-intro">
                    ...
                    <p>Thank you for taking the first step!</p><br>
                    <p>One of our Digital Marketing Consultants will call you shortly to schedule your one-on-one Strategy Call.</p><br>
                    <p>In the meantime, feel free to browse our blog for additional small business marketing tips.</p>
                </header>
            </div>
        </div>
    </div>
...
<div id="primary" class="content-area">
    ...
    <div id="recent-posts-widgets">
            <div id="recent-posts">
                <h2 class="tx-center">Digital Marketing Blog</h2>
