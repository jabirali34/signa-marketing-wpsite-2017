...
function xyz_amp_set_site_icon_url( $data ) {
	...
	$data[ 'site_icon_url' ] = get_stylesheet_directory_uri() . '/wp-content/uploads/amp-site-icon.png';
	return $data;
}
```
...
function xyz_set_custom_placeholder_image( $data ) {
	$data[ 'placeholder_image_url' ] = get_stylesheet_directory_uri() . '/wp-content/uploads/amp-iframe-placeholder.png';
	return $data;
}
```
...
function xyz_amp_modify_json_metadata( $metadata, $post ) {
	...
	$metadata['publisher']['logo'] = array(
		'@type' => 'ImageObject',
		'url' => get_template_directory_uri() . '/wp-content/uploads/my-amp-metadata-logo.png',
		'height' => 60,
		'width' => 600,
	);
